...
class Inventario:
    def __init__(self, master=None):
        ...
        self.path = "c:\\Users\\Cardenas Reyes\\Downloads\\Proyecto-OOP-main" #Esto se debe quitar antes de entregar
        self.db_name = self.path + '\\Inventario.db'
        ...
        icon_name = self.path + r"/f2.ico" #Cambiar a solo "f2.ico" para entregar
        ...
        self.treeProductos.bind("<<TreeviewSelect>>", self.HabEdit)
    ...
    #funciones especuales
    def HabEdit(self, event):
        EstadoSelec=self.treeProductos.selection()
        if EstadoSelec:
    ...
    def cancelar(self):
        ...
        self.EliminaAzul()
    #Elimina seleccion
    def EliminaAzul(self):
        EstadoSelec=self.treeProductos.selection()
        if EstadoSelec:
            elemento =EstadoSelec[0]
            self.treeProductos.selection_remove(elemento)
        #print(self.treeProductos.selection())
    ...
    def adiciona_Registro(self, event=None):
        ...
        if invalido:
            ...
            try:
                ...
                self.lee_treeProductos()
    # #def adiciona_RegistroEditado(self):
    #     invalido = ""
    #     #validacion idNit
    #     id = self.idNit.get()
        # if len(id) > 15:
